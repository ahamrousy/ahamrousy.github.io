...
export const person = {
  ...
  bios: {
    ...
    ar: {
      short:
        'أحمد عمروسي محاضر مصري في الذكاء الاصطناعي للأعمال وقيادي تسويقي. يُدرِّس إدارة التسويق في التعليم التنفيذي بكلية أنسي ساويرس لإدارة الأعمال بالجامعة الأمريكية بالقاهرة، ويشغل منصب مدير التسويق والعلاقات العامة في نايل إير، وأسَّس مِنوفا لتدريب الشركات على الذكاء الاصطناعي، ومقرها القاهرة وتغطي مصر والخليج.',
      medium:
